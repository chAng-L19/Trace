...
CAPABILITY_MARKERS: dict[str, frozenset[str]] = {
    ...
    "binary_reverse": frozenset({"ghidra", "radare", "rizin", "capstone", "frida", "disassemble", "decompile", "binary", "asc", "findrefs"}),
    "apk_decompile": frozenset({"asc", "apk", "android", "decompile", "getclass", "findrefs"}),
    "android_static_analysis": frozenset({"asc", "apk", "android", "manifest", "protection", "dex"}),
